...
$Ntel_p=htmlspecialchars($_POST['Ntel_p']);
$adr_p=htmlspecialchars($_POST['adr_p']);
$id_p=htmlspecialchars($_POST['id_p']);
    $sql=$bdd->prepare("UPDATE `patients` SET `adr_p` = '$adr_p', `Ntel_p` = '$Ntel_p' WHERE `patients`.`id_p` = '$id_p'"); 
    $sql->execute(); 
 }
?>
<?php
