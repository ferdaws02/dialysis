...
<div class="container-fluid">
	...
	<div class="collapse navbar-collapse" id="navbarResponsive">
		<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item ">
    <a class="nav-link "  href="profilmed.php">profile</a>
	</li>
...
<section class="container">
	...
	<table class="table table-hover">
		...
		<?php foreach ($patient as  $pat):?>
			...
			<td><a href="consulter.php?dossier=<?=$pat['id_p']?>&amp;id_med=<?=$_SESSION['nom_med']['id_med'];?>" class="btn btn-info p-2">consulte DPI</a>
<a href="vaccin.php?dossier=<?=$pat['id_p']?>&amp;id_med=<?=$_SESSION['nom_med']['id_med'];?>" class="btn btn-primary p-2"> fixe vaccin</a></td></tr>
		<?php endforeach;?>
	</table>
</section>
</body>
