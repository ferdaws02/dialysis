...
if(isset($_GET['pseudo'])){
	...
	$req=$bdd->prepare('SELECT * FROM infirmier WHERE pseudo_inf=?');
...
if(isset($_SESSION['user'])){
 if($_SESSION['user']['id']==$user['id']){
 	$set=1;
 	header("location:liDPI.php?pseudo=" .$_SESSION['nom_inf']['pseudo_inf']."organisation=".$_SESSION['nom_inf']['nom']);
 }else{$set=0;
 }
}else{
	$set=0;
...
<table>
	<tr>
		<td>pseudo: </td>
		<td><?php  echo $_SESSION['nom_inf']['pseudo_inf'];?></td>
	</tr>
		<tr>
			<td>adresse: </td>
		<td><?php  echo $_SESSION['nom_inf']['adr_inf'];?></td>
	</tr>
	<tr>
		<td>numéro de téléphone: </td>
		<td><?php  echo $_SESSION['nom_inf']['Ntel_inf'];?></td>
	</tr>
	<tr>
		<td>nom organisation sanitaire: </td>
		<td><?php  echo $_SESSION['nom_inf']['nom'];?></td>
	</tr>
	<?php if($set==0){ ?>
	<tr>
